...
import { Building, Building2, Calendar, Users } from 'lucide-react'
...
export function StatCards({ data }: StatCardsProps) {
	const stats = [
		...
		{
			title: 'Davlat Universitetlari',
			value: data.generalStatistics.stateUniversities,
			icon: Building,
			description: `${data.generalStatistics.privateUniversities} xususiy, ${data.generalStatistics.branchUniversities} filial`,
			color: 'bg-red-500',
		},
	]
